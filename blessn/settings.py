"""
Django settings for blessn project.
...
WSGI_APPLICATION = 'blessn.wsgi.application'
...
STATICFILES_DIRS = (os.path.join(BASE_DIR, "web_build", "static"),)
...
BOOKING_FEE = int(env.str("BOOKING_FEE", "0"))
